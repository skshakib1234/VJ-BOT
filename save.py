...
async def send_start(client: Client, message: Message):
    ...
    await client.send_message(message.chat.id, f"<b>👋 Hi {message.from_user.mention}, COMMAND \n\n /login \n\n /help</b>", reply_markup=reply_markup, reply_to_message_id=message.id)
    return
        ...
        for msgid in range(fromID, toID+1):
            ...
            if "https://t.me/c/" in message.text:
                ...
                if user_data['session'] is None:
                    await client.send_message(message.chat.id, strings['already_logged_in'])
                    return
